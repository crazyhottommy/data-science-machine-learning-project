...
1. First, I will break training set into K subsets (in this case a 3-fold cross validation)  
...
## there are some missing values, use k-nearest neighbors to impute the missing numeric values
